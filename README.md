...
|------|-------|-------|--------|--------------|----------|------|
| 2023 | arXiv | [Can GPT-4 Perform Neural Architecture Search? (GENIUS)](https://arxiv.org/abs/2304.10970) | ① Code-gen | First probe: prompt GPT-4 to output image-classifier code from task description; shows strong zero-shot design priors. | — | [✓](https://github.com/mingkai-zheng/GENIUS) |
| 2023 | NeurIPS | [EvoPrompting: Language Models for Code-Level NAS](https://arxiv.org/abs/2302.14838) | ①+② | LLM writes full model code; an evolutionary loop (seeded by human examples) mutates code, selects by validation accuracy. | — | [✓](https://github.com/algopapi/EvoPromptingReinforcementlearning) |
| 2024 | CVPR | [AutoMMLab: Automatically Generating Deployable Models from Language Instructions](https://arxiv.org/abs/2402.15351) | ① Code-gen | LLM translates natural-language CV task instructions into a deployable model pipeline. | — | — |
